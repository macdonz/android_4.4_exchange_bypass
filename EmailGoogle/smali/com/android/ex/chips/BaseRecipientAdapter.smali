...
.method private constructEntryList(Ljava/util/LinkedHashMap;Ljava/util/List;)Ljava/util/List;
    ...
    :cond_0
    #v1=(Conflicted);v2=(Conflicted);v3=(Conflicted);v4=(Reference);v5=(Conflicted);v6=(Conflicted);v7=(Integer);v8=(Conflicted);
    ...
    .end local v6           #size:I
    :cond_2
    #v2=(Conflicted);v3=(Conflicted);v5=(Conflicted);v6=(Conflicted);
    iget v8, p0, Lcom/android/ex/chips/BaseRecipientAdapter;->mPreferredMaxResultCount:I
...
.method private static putOneEntry(Lcom/android/ex/chips/BaseRecipientAdapter$TemporaryEntry;ZLjava/util/LinkedHashMap;Ljava/util/List;Ljava/util/Set;)V
    ...
    .line 679
    :cond_0
    #v1=(Boolean);v2=(Uninit);v3=(Uninit);v4=(Uninit);v5=(Uninit);v6=(Uninit);v7=(Uninit);v8=(Uninit);v9=(Uninit);v10=(Uninit);v11=(Uninit);v12=(Uninit);
    iget-object v1, p0, Lcom/android/ex/chips/BaseRecipientAdapter$TemporaryEntry;->destination:Ljava/lang/String;
    ...
    .line 687
    :cond_1
    #v2=(Uninit);v3=(Uninit);v4=(Uninit);v5=(Uninit);v6=(Uninit);v7=(Uninit);v8=(Uninit);v9=(Uninit);v10=(Uninit);v11=(Uninit);
    ...
    :cond_2
    #v1=(Boolean);v2=(LongHi);v3=(Uninit);v4=(Uninit);v5=(Uninit);v6=(Uninit);v7=(Uninit);v8=(Uninit);v9=(Uninit);v10=(Uninit);v11=(Uninit);v12=(Uninit);
...
.method public static setupOtherDirectories(Landroid/content/Context;Landroid/database/Cursor;Landroid/accounts/Account;)Ljava/util/List;
    ...
    :cond_0
    :goto_0
    #v0=(Conflicted);v1=(Conflicted);v2=(Conflicted);v4=(Conflicted);v5=(Conflicted);v7=(Reference);v8=(Conflicted);v9=(Conflicted);v10=(Conflicted);v11=(Conflicted);v12=(Conflicted);
    ...
    :cond_1
    :goto_1
    #v9=(Conflicted);v11=(Conflicted);v12=(Conflicted);
    if-eqz p2, :cond_2
    ...
    :cond_2
    #v0=(Conflicted);v10=(Conflicted);v11=(Conflicted);v12=(Conflicted);
    ...
    :cond_3
    #v1=(Conflicted);v2=(Conflicted);v4=(Conflicted);v5=(Conflicted);v8=(Conflicted);v10=(Boolean);
    if-eqz v7, :cond_4
...
.method protected fetchPhoto(Lcom/android/ex/chips/RecipientEntry;Landroid/net/Uri;)V
    ...
    .line 855
    :cond_1
    #v0=(Reference);v1=(Uninit);v2=(Uninit);v4=(Uninit);v5=(Uninit);v7=(Uninit);
    iget-object v0, p0, Lcom/android/ex/chips/BaseRecipientAdapter;->mContentResolver:Landroid/content/ContentResolver;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :goto_0
    #v0=(Conflicted);v9=(Reference);v12=(Conflicted);v13=(Conflicted);v14=(Conflicted);
    ...
    :cond_2
    #v0=(Conflicted);v2=(Conflicted);v12=(Conflicted);v13=(Conflicted);v14=(Conflicted);v15=(Conflicted);
    invoke-virtual {v7}, Lcom/android/ex/chips/RecipientEntry;->isFirstLevel()Z
    ...
    :cond_3
    :goto_2
    #v10=(Conflicted);v11=(Conflicted);v12=(Integer);v13=(Conflicted);
    return-object v9
    ...
    :cond_4
    #v0=(Integer);v2=(Uninit);v3=(Uninit);v4=(Uninit);v6=(Uninit);v8=(Uninit);v9=(Uninit);v10=(Uninit);v11=(Uninit);v12=(Boolean);v13=(Uninit);v14=(Uninit);v15=(Uninit);
    move-object/from16 v0, p0
    ...
    :cond_5
    #v0=(Conflicted);v3=(Reference);v4=(Reference);v6=(Reference);v8=(Reference);v12=(Boolean);v13=(Conflicted);v14=(Conflicted);
    const/4 v12, 0x0
    ...
    :cond_6
    #v2=(Conflicted);v11=(Reference);v15=(Conflicted);
