...
.method private onParseError(Ljava/lang/Exception;)V
    ...
    :cond_1
    #v0=(Integer);v2=(PosByte);v3=(Uninit);v4=(Uninit);
...
.method private parseLiteral()Lcom/android/email/mail/store/imap/ImapString;
    ...
    .end local v2           #size:I
    :catch_0
    #v0=(Uninit);v2=(Uninit);v3=(Conflicted);
    move-exception v1
    ...
    :cond_0
    #v0=(Reference);v1=(Uninit);v2=(Integer);v3=(Integer);v4=(Uninit);
...
.method private parseResponse()Lcom/android/email/mail/store/imap/ImapResponse;
    ...
    :cond_1
    #v1=(Uninit);v2=(Uninit);v4=(Uninit);v5=(Uninit);v6=(Uninit);v7=(Uninit);v8=(PosByte);v9=(PosByte);
    const/16 v8, 0x2a
    ...
    :cond_4
    #v1=(Uninit);v2=(Uninit);v4=(Uninit);v5=(Uninit);v6=(Uninit);v7=(Uninit);v8=(PosByte);
    const/16 v8, 0x20
    ...
    .restart local v4       #responseToDestroy:Lcom/android/email/mail/store/imap/ImapResponse;
    :cond_5
    #v1=(Reference);v4=(Reference);v8=(Boolean);
    const/4 v8, 0x0
    ...
    .restart local v7       #tag:Ljava/lang/String;
    :cond_7
    #v0=(Integer);v1=(Reference);v2=(Uninit);v3=(Null);v4=(Reference);v6=(Uninit);v7=(Reference);v8=(Integer);v9=(PosByte);
    const/16 v8, 0xd
    ...
    .restart local v3       #responseToDestroy:Lcom/android/email/mail/store/imap/ImapResponse;
    :catchall_1
    #v0=(Conflicted);v1=(Uninit);v4=(Conflicted);v7=(Conflicted);v8=(Conflicted);
    move-exception v8
...
.method public readResponse()Lcom/android/email/mail/store/imap/ImapResponse;
    ...
    #v2=(Reference);
    invoke-virtual {v1, v5, v2}, Lcom/android/email/mail/store/imap/ImapResponse;->is(ILjava/lang/String;)Z
