...
.method getOrCompute(Ljava/lang/Object;ILcom/google/common/base/Function;)Ljava/lang/Object;
    ...
    :cond_3
    :goto_2
    #v0=(Conflicted);v3=(Boolean);v5=(Conflicted);v11=(Conflicted);v12=(Conflicted);
    if-eqz v3, :cond_4
    ...
    :cond_5
    :try_start_5
    #v1=(Null);v3=(One);v5=(Reference);v10=(Conflicted);v11=(Reference);v12=(Boolean);
    invoke-interface {v4}, Lcom/google/common/collect/MapMakerInternalMap$ReferenceEntry;->getValueReference()Lcom/google/common/collect/MapMakerInternalMap$ValueReference;
    ...
    .end local v11           #valueReference:Lcom/google/common/collect/MapMakerInternalMap$ValueReference;,"Lcom/google/common/collect/MapMakerInternalMap$ValueReference<TK;TV;>;"
    :catchall_0
    #v0=(Conflicted);v3=(Boolean);v5=(Conflicted);v6=(Conflicted);v7=(Conflicted);v8=(Conflicted);v9=(Conflicted);v10=(Conflicted);v11=(Conflicted);v12=(Conflicted);
    move-exception v12

    :goto_5
    :try_start_6
    #v1=(Reference);v12=(Reference);
    invoke-virtual {p0}, Lcom/google/common/collect/ComputingConcurrentHashMap$ComputingSegment;->unlock()V
    ...
    :cond_6
    :try_start_7
    #v0=(Integer);v1=(Null);v3=(One);v4=(Reference);v5=(Reference);v6=(Reference);v7=(Integer);v8=(Integer);v9=(Reference);v10=(Reference);v11=(Reference);
    iget-object v12, p0, Lcom/google/common/collect/MapMakerInternalMap$Segment;->map:Lcom/google/common/collect/MapMakerInternalMap;
    ...
    :cond_8
    :try_start_9
    #v10=(Conflicted);v11=(Conflicted);v12=(Integer);
    ...
    :cond_9
    :try_start_a
    #v0=(Reference);v2=(Reference);v3=(Boolean);v5=(Conflicted);v12=(Conflicted);
    invoke-interface {v4, v2}, Lcom/google/common/collect/MapMakerInternalMap$ReferenceEntry;->setValueReference(Lcom/google/common/collect/MapMakerInternalMap$ValueReference;)V
    :try_end_a
    ...
    :cond_a
    :try_start_b
    #v0=(Conflicted);v1=(Conflicted);v2=(Conflicted);v3=(Conflicted);v6=(Conflicted);v7=(Conflicted);v8=(Conflicted);v9=(Conflicted);
    ...
    .end local v10           #value:Ljava/lang/Object;,"TV;"
    :cond_b
    #v10=(Conflicted);v12=(Boolean);v13=(Conflicted);
    const/4 v12, 0x0
    ...
    .restart local v9       #table:Ljava/util/concurrent/atomic/AtomicReferenceArray;,"Ljava/util/concurrent/atomic/AtomicReferenceArray<Lcom/google/common/collect/MapMakerInternalMap$ReferenceEntry<TK;TV;>;>;"
    :catchall_2
    #v1=(Null);v2=(Reference);v3=(Boolean);v6=(Reference);v7=(Integer);v8=(Integer);v9=(Reference);v12=(Conflicted);
    move-exception v12
